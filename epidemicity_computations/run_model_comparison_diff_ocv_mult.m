...
f = figure(4002);
    ...
    hold on
    for i = 1:length(multipliers)
    plot(timed,Rt(i,:),'linewidth',1);
    end
    lgd = legend('1', '2', '3', '4', '5','NumColumns',2);
    title(lgd, 'OCV multiplier')
