function [ModPred,times_out, y] = m5c(x,Extra)
    ...
    %Fitting Parameters
    p.theta= 0.362459589820387;
    p.m= 0.154351869727813;
    p.D= 1.95720352143598;
    p.phi= 0.0646065121532742;
    p.rho = 0.0179252392628796;
    p.sigma= 0.0228291824042519;
    p.muB= 0.143461256348654;
    p.beta0= 6.22904967581401;
    p.psi = 0.0833663655741586;
    p.t0= 890;
    p.r = 6.46915035349036e-05;
